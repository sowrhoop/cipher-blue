...
authselect create-profile cipherblue -b sssd > /dev/null 2>&1
...
authselect select custom/cipherblue with-pamaccess with-faillock without-nullok --quiet 1> /dev/null
